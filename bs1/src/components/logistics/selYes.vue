<template>
	<div class="root">
		...
		<el-table :data="tableData" border style="width: 100%">
			...
			<el-table-column  prop="fintime" label="完成时间" width="200">
			</el-table-column>
			<el-table-column  prop="wname" label="姓名" width="200">
			</el-table-column>
			<el-table-column  prop="snote" label="原因" width="200">
			</el-table-column>
			<el-table-column  prop="spos" label="位置" width="200">
			</el-table-column>
...
<script>
	export default {
		methods: {
			...
			selectAll() {
				fetch(`/api/service/selectAll?like=${this.like}&flag=1`).then(function(e) {
					return e.text();
				}).then((e) => {
					this.pages = e;
				})
			...
			selectPage() {
				...
				fetch("/api/service/selectPage?" + params+"&flag=1").then(function(e) {
					return e.json();
				}).then((e) => {
					if(e.message != "err") {
						this.tableData = e;
